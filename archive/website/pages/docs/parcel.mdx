...
> If you still use Parcel v1, [`@svgr2/parcel-plugin-svgr`](https://www.npmjs.com/package/@svgr2/parcel-plugin-svgr) is deprecated and only compatible with Parcel v1.
