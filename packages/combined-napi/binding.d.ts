...
/* eslint-disable */
export declare function extend(extend: Extends, options?: Jobs | undefined | null): Jobs

export declare function transform(source: string, transformOptions?: TransformOptions | undefined | null, optimiseOptions?: Jobs | undefined | null): string
...
export interface TransformOptions {
  ...
  jsxRuntimeImport?: TransformOptionsJsxRuntimeImport
  importSource?: string
}

export interface TransformOptionsJsxRuntimeImport {
  source: string
  namespace?: string
