...
```bash
npm install --save-dev @svgr2/cli @svgr2/plugin-svgo @svgr2/plugin-jsx @svgr2/plugin-prettier npm-watch npm-run-all
```
...
```js
{
  ...
  "scripts": {
    ...
    "icons": "npx @svgr2/cli --out-dir app/components/icons -- app/icons",
